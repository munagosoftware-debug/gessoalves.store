  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', maxWidth: '600px' }}>
        <h3 style={{ color: '#ffffff', fontSize: '1.8rem', marginBottom: '16px' }}>Área de Atuação</h3>
        <p style={{ color: 'var(--color-silver-light)', lineHeight: '1.6' }}>
      ...
      <div style={{
        ...
        <div className="metallic-card" style={{ padding: '24px' }}>
          <h4 style={{ color: '#ffffff', fontSize: '1.2rem', marginBottom: '8px', borderBottom: '2px solid var(--color-cyan)', paddingBottom: '8px' }}>Nossa Base</h4>
          <p style={{ color: 'var(--color-silver-light)', marginBottom: '16px', fontWeight: 'bold' }}>
            📍 Rua Inquiririm, 687 - Vila Indiana (Butantã)
          </p>
          
          <h4 style={{ color: '#ffffff', fontSize: '1.1rem', marginBottom: '12px' }}>Raio de Atendimento</h4>
          <p style={{ color: 'var(--color-silver-light)', marginBottom: '16px' }}>
